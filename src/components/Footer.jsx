...
export default function Footer(){
    return(
        <footer className="bg-black grid grid-cols-1 justify-center items-center gap-10 text-white text-center py-10 px-6 md:max-w-6xl mx-auto md:px-0 md:auto-rows-auto md:grid-cols-2 md:text-left">
