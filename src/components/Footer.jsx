...
export default function Footer(){
    return(
        ...
        <div className="relative grid grid-cols-1 justify-center items-center gap-10 text-white text-center py-10 px-6 md:max-w-6xl mx-auto md:auto-rows-auto md:grid-cols-2 md:text-left">
            <div className="absolute top-0 left-1/2 transform -translate-x-1/2 md:translate-0 md:left-6 w-25 h-1 bg-burnt-orange"></div>
            ...
            <nav className="flex flex-col justify-center items-center gap-5 font-bold text-sm md:flex-row md:justify-start md:col-span-full lg:col-start-2 lg:col-end-3 lg:row-start-1 lg:row-end-2 lg:justify-end">
                <NavLink to="/" className="tracking-widest  hover:text-burnt-orange">HOME</NavLink>
                <NavLink to="/" className="tracking-widest  hover:text-burnt-orange">HEADPHONES</NavLink>
                <NavLink to="/" className="tracking-widest  hover:text-burnt-orange">SPEAKERS</NavLink>
                <NavLink to="/" className="tracking-widest  hover:text-burnt-orange">EARPHONES</NavLink>  
            </nav>
