  ...
  return (
    <>
      ...
      <div className="relative">
        ...
        <img src={mdImageHeader} className="hidden md:block" alt="Header image" />
        <div className="text-white absolute inset-0 flex flex-col justify-center items-center text-center px-8  md:max-w-[380px] md:mx-auto md:px-0">
